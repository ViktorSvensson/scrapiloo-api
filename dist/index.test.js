...
describe("Performs math operations", () => {
    test("Can multiply", () => {
        expect(data(100, "float").mul(data(10, "float")).valueOf()).toBeCloseTo(1000);
        expect(data(120, "integer").mul(data(5, "integer")).valueOf()).toBeCloseTo(600);
        expect(data(100, "integer").mul(data(10, "float")).valueOf()).toBeCloseTo(1000);
        expect(data(120, "float").mul(data(5, "integer")).valueOf()).toBeCloseTo(600);
        expect(data(1.22, "float").mul(data(10, "float")).valueOf()).toBeCloseTo(12.2);
        expect(data(1.22, "integer").mul(data(10, "integer")).valueOf()).toBeCloseTo(12);
        expect(data(1.22, "integer").mul(data(10, "float")).valueOf()).toBeCloseTo(12);
        expect(data(1.22, "float").mul(data(10, "integer")).valueOf()).toBeCloseTo(12.2);
    });
    test("Can divide", () => {
        expect(data(100, "float").div(data(10, "float")).valueOf()).toBeCloseTo(100 / 10);
        expect(data(120, "integer").div(data(5, "integer")).valueOf()).toBeCloseTo(120 / 5);
        expect(data(100, "integer").div(data(10, "float")).valueOf()).toBeCloseTo(100 / 10);
        expect(data(120, "float").div(data(5, "integer")).valueOf()).toBeCloseTo(120 / 5);
        expect(data(1.22, "float").div(data(10, "float")).valueOf()).toBeCloseTo(1.22 / 10);
        expect(data(1.22, "integer").div(data(10, "integer")).valueOf()).toBeCloseTo(0);
        expect(data(1.22, "integer").div(data(10, "float")).valueOf()).toBeCloseTo(0);
        expect(data(1.22, "float").div(data(10, "integer")).valueOf()).toBeCloseTo(0.122);
    });
    test("Can subtract", () => {
        expect(data(100, "float").sub(data(10, "float")).valueOf()).toBeCloseTo(90);
        expect(data(120, "integer").sub(data(5, "integer")).valueOf()).toBeCloseTo(115);
        expect(data(100, "integer").sub(data(10, "float")).valueOf()).toBeCloseTo(90);
        expect(data(120, "float").sub(data(5, "integer")).valueOf()).toBeCloseTo(115);
        expect(data(11.22, "float").sub(data(10, "float")).valueOf()).toBeCloseTo(1.22);
        expect(data(11.22, "integer").sub(data(10, "integer")).valueOf()).toBeCloseTo(1);
        expect(data(11.22, "integer").sub(data(10, "float")).valueOf()).toBeCloseTo(1);
        expect(data(11.22, "float").sub(data(10, "integer")).valueOf()).toBeCloseTo(1.22);
    });
    test("Can add", () => {
        expect(data(100, "float").add(data(10, "float")).valueOf()).toBeCloseTo(110);
        expect(data(120, "integer").add(data(5, "integer")).valueOf()).toBeCloseTo(125);
        expect(data(100, "integer").add(data(10, "float")).valueOf()).toBeCloseTo(110);
        expect(data(120, "float").add(data(5, "integer")).valueOf()).toBeCloseTo(125);
        expect(data(1.22, "float").add(data(10, "float")).valueOf()).toBeCloseTo(11.22);
        expect(data(1.22, "integer").add(data(10, "integer")).valueOf()).toBeCloseTo(11);
        expect(data(1.22, "integer").add(data(10, "float")).valueOf()).toBeCloseTo(11);
        expect(data(1.22, "float").add(data(10, "integer")).valueOf()).toBeCloseTo(11.22);
    });
});
...
describe("TimeType: Can calculate duration", () => {
    test("Can calculate hours between two timestamps", () => {
        expect(data("12:00", "time").getDuration(data("14:00", "time")).hours).toEqual(2);
        expect(data("12:00", "time").getDuration(data("14:30", "time")).hours).toEqual(2.5);
        expect(data("00:00", "time").getDuration(data("09:45", "time")).hours).toEqual(9.75);
    });
    test("Can calculate minutes between two timestamps", () => {
        expect(data("12:00", "time").getDuration(data("14:00", "time")).minutes).toEqual(2 * 60);
        expect(data("12:00", "time").getDuration(data("14:30", "time")).minutes).toEqual(2 * 60 + 30);
        expect(data("00:00", "time").getDuration(data("09:45", "time")).minutes).toEqual(9 * 60 + 45);
    });
});
describe("BooleanType: Printing", () => {
    ...
    test("Can pretty print non-boolean values", () => {
        expect(data("aksdjaklsdjl", "boolean").pretty()).toEqual("–");
        expect(data(123123123, "boolean").pretty()).toEqual("–");
        expect(data(null, "boolean").pretty()).toEqual("–");
...
describe("BooleanType: Label config", () => {
    test("Can use another trueLabel", () => {
        expect(data(true, "boolean").setConfig({ trueLabel: "Oui" }).pretty()).toEqual("Oui");
        expect(data(false, "boolean").setConfig({ trueLabel: "Oui" }).pretty()).toEqual("Nej");
    });
    test("Can use another falseLabel", () => {
        expect(data(false, "boolean").setConfig({ falseLabel: "Never" }).pretty()).toEqual("Never");
        expect(data(true, "boolean").setConfig({ falseLabel: "Never" }).pretty()).toEqual("Ja");
    });
    test("Can use both trueLabel and falseLabel", () => {
        expect(data(false, "boolean")
            .setConfig({ trueLabel: "Oui", falseLabel: "Never" })
            .pretty()).toEqual("Never");
        expect(data(true, "boolean")
            .setConfig({ trueLabel: "Oui", falseLabel: "Never" })
            .pretty()).toEqual("Oui");
    });
    test("Can use React Elements as labels", () => {
        ...
        expect(data(false, "boolean").setConfig({ trueLabel, falseLabel }).pretty()).toBe(falseLabel);
        expect(data(true, "boolean").setConfig({ trueLabel, falseLabel }).pretty()).toBe(trueLabel);
    });
});
...
describe("Serialization", () => {
    test("Can serialize IntegerType", () => {
        ...
        expect(json).toEqual('{"type":"integer","value":123,"config":{"unit":{"type":"unit","value":"day"},"displayInterval":true}}');
        const unserialized = JSON.parse(json);
        const restored = data(unserialized?.value, "integer").setConfig(unserialized?.config ?? {});
